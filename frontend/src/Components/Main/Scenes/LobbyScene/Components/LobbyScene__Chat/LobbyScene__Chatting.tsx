...
const LobbyScene__Chatting = (): JSX.Element => {
    ...
    const chatsList = testChats.map((chat) => <LobbyScene__Chat key={Math.random()} chatInfo={chat}/>)

    return (
        <div className={`${styles.lobby_scene_chatting} ${styles.lobby_scene_components}`}>
            <div className={styles.lobby_scene_chatting__title}>
                채팅
            </div>
            <div className={styles.lobby_scene_chatting__body}>
                ...
                <div className={styles.lobby_scene_chatting__chattingBar}>
                    <div className={styles.lobby_scene_chatting__chattingBar__mode} onClick={onClickMode}>
                        {mode}
                    </div>
                    <div className={styles.lobby_scene_chatting__chattingBar__chatContainer}>
                        <textarea className={styles.lobby_scene_chatting__chattingBar__chat} onChange={onChatChange} value={chat}></textarea>
                    </div>
                    <div className={styles.lobby_scene_chatting__chattingBar__send} onClick={sendChat}>
                        전송
                    </div>
                </div>
            </div>
